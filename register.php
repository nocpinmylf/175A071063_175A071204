          ...
          <div class="tab-pane fade in show active" id="panel7" role="tabpanel">
            ...
            <div class="modal-footer">
              <div class="options text-center text-md-right mt-1">
                <p>Chưa Có Tài Khoản? <a href="#" class="blue-text">Đăng Ký</a></p>
                <p>Quên<a href="#" class="blue-text">Mật Khẩu?</a></p>
              </div>
          ...
          <div class="tab-pane fade" id="panel8" role="tabpanel">
            ...
            <div class="modal-body">
              ...
              <div class="md-form form-sm mb-4">
                ...
                <label data-error="wrong" data-success="right" for="modalLRInput14">Lặp Lại Mật Khẩu</label>
              </div>

              <div class="text-center form-sm mt-2">
                <button class="btn btn-info">Đăng Ký<i class="fas fa-sign-in ml-1"></i></button>
              </div>
